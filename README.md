...
- **Zwei Layouts**: vertikal oder horizontal
- **Zwei Darstellungen**: normal (Karten-Hintergrund) oder transparent mit Blur-Effekt
...
| ----------------------- | ------- | ---------- | ----------------------------------------------------------------------------- |
| `mode`                  | string  | `covers`   | `covers`, `door_window`, `light` oder `battery`                              |
| `entities`               | list    | `[]`       | Liste der zu überwachenden Entitäten                                         |
| `name`                   | string  | –          | Überschreibt den automatisch generierten Text                                |
| `icon_active`            | string  | –          | Icon bei aktivem Zustand (offen/an/schwach); sonst automatisches Standard-Icon |
| `icon_inactive`          | string  | –          | Icon bei inaktivem Zustand (geschlossen/aus/OK)                              |
...
| `battery_threshold`      | number  | `20`       | Nur Modus `battery`: Schwellwert in % für "schwach"                          |
| `layout`                 | string  | `vertical` | `vertical` oder `horizontal`                                                  |
